                ...
                return (
                  <li key={i}>
                    <button
                      ...
                      className="group flex flex-col items-center gap-2 cursor-pointer disabled:cursor-not-allowed appearance-none bg-transparent border-none p-0 focus-visible:outline-none focus:outline-none"
                    >
