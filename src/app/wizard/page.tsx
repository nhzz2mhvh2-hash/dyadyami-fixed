              ...
              {steps.map((s, i) => (
                <li key={i}>
                  <button
                    ...
                    className={cn(
                      "flex flex-col items-center gap-2 bg-transparent border-none p-0 outline-none transition-opacity rounded-sm group",
                      i + 1 < step ? "cursor-pointer" : "cursor-default",
                      i + 1 === step ? "opacity-100" : "opacity-50",
                      i + 1 < step && "focus-visible:ring-1 focus-visible:ring-cyan-luxury focus-visible:ring-offset-4 focus-visible:ring-offset-black"
                    )}
                  ...
                  >
                    ...
                    <span className={cn("text-[8px] uppercase tracking-widest hidden md:block", step === i + 1 ? "text-white" : "text-zinc-600 group-hover:text-zinc-400 transition-colors")}>
                      {s.title}
                    </span>
                  </button>
                </li>
