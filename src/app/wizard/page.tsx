    ...
    <main className="min-h-screen bg-black overflow-hidden flex flex-col text-white">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pt-20">
        <div className="w-full max-w-4xl">
          {/* Progress Indicator */}
          <nav aria-label="Progress" className="relative mb-12 w-full">
              ...
              {steps.map((s, i) => (
                <li key={i}>
                  <button
                    ...
                    className="flex flex-col items-center gap-2 group outline-none appearance-none bg-transparent border-none p-0 cursor-pointer disabled:cursor-not-allowed"
                  >
                    ...
                    <span className={cn("text-[8px] uppercase tracking-widest hidden md:block transition-colors", step === i + 1 ? "text-white" : "text-zinc-600")}>
                      {s.title}
                    </span>
                  </button>
                </li>
