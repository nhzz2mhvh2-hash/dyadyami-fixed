                ...
                return (
                  <li key={i}>
                    <button
                      ...
                      aria-label={`${s.title} (Step ${stepNum} of ${steps.length})${isCompleted ? ", completed" : isActive ? ", active" : ", locked"}`}
                      className="flex flex-col items-center gap-2 group focus:outline-none cursor-pointer disabled:cursor-not-allowed"
                    >
                      <div
                        className={cn(
                          "w-3 h-3 rounded-full border-2 transition-all duration-500",
                          "group-focus-visible:ring-2 group-focus-visible:ring-cyan-luxury group-focus-visible:ring-offset-4 group-focus-visible:ring-offset-black",
                          isCompleted
                      ...
                      <span
                        className={cn(
                          "text-[8px] uppercase tracking-widest hidden md:block transition-colors duration-500",
                          isActive ? "text-white" : "text-zinc-600 group-hover:text-zinc-400 group-disabled:group-hover:text-zinc-600"
                        )}
                      >
                        {s.title}
                      </span>
