    ...
    <main className="min-h-screen bg-black overflow-hidden flex flex-col text-white">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pt-20">
        <div className="w-full max-w-4xl">
          {/* Progress Indicator */}
          <nav aria-label="Progress" className="w-full mb-12 relative flex items-center">
            <div className="absolute top-[6px] left-0 w-full h-[1px] bg-white/5" />
            <ol className="w-full flex justify-between relative z-10">
              {steps.map((s, i) => {
                ...
                return (
                  <li key={i} className="flex flex-col items-center">
                    <button
                      ...
                      className="group flex flex-col items-center gap-2 focus:outline-none appearance-none bg-transparent border-none p-0 cursor-pointer disabled:cursor-not-allowed"
                    >
                      <div className={cn("w-3 h-3 rounded-full border-2 transition-all duration-500 group-focus-visible:ring-2 group-focus-visible:ring-cyan-luxury group-focus-visible:ring-offset-4 group-focus-visible:ring-offset-black",
                      ...
                      <span className={cn("text-[8px] uppercase tracking-widest hidden md:block transition-colors duration-500",
                        isActive ? "text-white" : isNavigable ? "text-zinc-400 group-hover:text-cyan-luxury" : "text-zinc-600"
                      )}>
                        {s.title}
                      </span>
                    </button>
