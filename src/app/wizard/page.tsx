              ...
              {steps.map((s, i) => (
                <li key={i} className="flex flex-col items-center gap-2">
                  <button
                    ...
                    className={cn(
                      "w-3 h-3 rounded-full border-2 transition-all duration-500 outline-none focus-visible:ring-2 focus-visible:ring-cyan-luxury focus-visible:ring-offset-4 focus-visible:ring-offset-black",
                      step > i + 1 ? "bg-cyan-luxury border-cyan-luxury cursor-pointer" :
