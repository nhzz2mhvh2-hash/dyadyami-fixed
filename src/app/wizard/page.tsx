      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pt-20">
        <div className="w-full max-w-4xl">
          ...
          <nav aria-label="Progress" className="mb-12 relative">
            ...
            <ol className="flex justify-between list-none p-0">
              {steps.map((s, i) => (
                <li key={i}>
                  <button
                    type="button"
                    className="flex flex-col items-center gap-2 cursor-pointer bg-transparent border-none p-0 disabled:cursor-default"
