                ...
                return (
                  <li key={i} className="flex flex-col items-center">
                    <button
                      ...
                      className="appearance-none bg-transparent border-none p-0 cursor-pointer disabled:cursor-not-allowed flex flex-col items-center gap-2 group focus:outline-none"
                    >
