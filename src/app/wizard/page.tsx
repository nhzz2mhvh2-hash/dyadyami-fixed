      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 pt-20">
        <div className="w-full max-w-4xl">
          ...
          <nav aria-label="Expedition Progress" className="mb-12 relative w-full">
            <div className="absolute top-[6px] left-0 w-full h-[1px] bg-white/10 -z-10" />
                ...
                return (
                  <li key={i}>
                    <button
                      ...
                      className={cn(
                        "flex flex-col items-center gap-2 transition-all focus:outline-none group",
                        canNavigate ? "cursor-pointer" : "cursor-default"
                      )}
                    >
                      <div className={cn("w-3 h-3 rounded-full border-2 transition-all duration-500 group-focus-visible:ring-2 group-focus-visible:ring-white group-focus-visible:ring-offset-4 group-focus-visible:ring-offset-black",
